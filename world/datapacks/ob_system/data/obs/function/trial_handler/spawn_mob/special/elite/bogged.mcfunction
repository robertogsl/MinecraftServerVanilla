...
summon bogged ~ ~ ~ {Tags:["cob.trial_mob","cob.trial_mob.elite","cob.spawned"],ArmorDropChances:[-327.670F,-327.670F,-327.670F,-327.670F],HandDropChances:[-327.670F,-327.670F],Health:25f,Attributes:[{Name:generic.max_health,Base:25},{Name:generic.scale,Base:1.01}],DeathLootTable:"obs:entity/trial_elite"}
